...
<META HTTP-EQUIV="Refresh"
      CONTENT="<%=UPLOAD_MONITOR_REFRESH%>;URL=<%=browser_name %>?uplMonitor=<%=URLEncoder.encode(fname)%>">
</head>
<body>
<b>Upload of <%=fname%>
</b><br><br>
...
<table>
    <tr>
        ...
        <td><input type="checkbox" name="Backup" checked>Write backup</td>
    </tr>
    <tr>
...
<form action="<%= browser_name %>" method="Post" name="FileList">
    ...
    <p>
        ...
        <input title="Download selected files and directories as one zip file" class="button" type="Submit"
