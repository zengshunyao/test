...
class MethodProxy implements InvocationHandler {
    ...
    public Object invoke(Object proxy, Method method, Object[] args) throws Throwable {
        System.out.println(System.currentTimeMillis() + "-客户端--当前线程-----------" + Thread.currentThread().getName());
    ...
    public Object rpcInvoke(Method method, Object[] args) {
        ...
        try {
            ...
            System.out.println("当前线程----" + Thread.currentThread().getName() + "-------异步调用1 等结果------------");
            ChannelFuture f = b.connect("localhost", 8080).sync();

            System.out.println("当前线程----" + System.currentTimeMillis() + "---------------异步调用1 等结果-----------------" + msg);
        ...
        System.out.println("当前线程----" + Thread.currentThread().getName() + "-------异步调用2 等结果------------");
