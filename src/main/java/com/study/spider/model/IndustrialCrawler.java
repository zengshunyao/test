...
import com.study.spider.pojo.Industrial;
...
@Deprecated
public class IndustrialCrawler extends WebCrawler {
    ...
    public static List<Industrial> industrials = new LinkedList<Industrial>();
    ...
    public boolean shouldVisit(Page referringPage, WebURL url) {
        ...
        return !IGNORE_URL_FILTERS.matcher(href).matches()
                && href.startsWith("http://www.sckjfp.com/Index/industryList/p/")
                && href.matches("^http://www.sckjfp.com/Index/industryList/p/(\\d){1,}.html$");
    }
            ...
            for (int i = 0; i < trList.size(); i++) {
                ...
                for (int j = 0; j < tdList.size(); j++) {
                    ...
                    if (j >= 5) {
                        ...
                        try {
                            Field field = Industrial.ORDER_MAP.get(j + 2);
                            Method setMethod = Industrial.class.getMethod("set"
