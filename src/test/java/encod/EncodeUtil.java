...
/**********************************************************************
 * &lt;p&gt;文件名：EncodeUtil.java &lt;/p&gt;
 * &lt;p&gt;文件描述：自动识别文件编码格式并批量转换(描述该文件做什么)
...
//            System.out.println("文件编码格式为：" + code);
            ...
            //GBK编码格式源码路径
            String srcDirPath = "E:\\study_Example\\oschina\\spring-framework";
            //转为UTF-8编码格式源码路径
            String utf8DirPath = "E:\\study_Example\\oschina\\spring-framework-utf8";

            //获取所有java文件
            Collection<File> javaGbkFileCol = FileUtils.listFiles(new File(srcDirPath), new String[]{"java"}, true);

            for (File javaGbkFile : javaGbkFileCol) {
                if (CODE_GBK.equals(getEncode(new BufferedInputStream(new FileInputStream(javaGbkFile)), false))) {
                    //UTF8格式文件路径
