...
//            System.out.println(stackTraceElement.toString());
            System.out.println(toMyString(stackTraceElement));
        }
    }

    public static String toMyString(StackTraceElement stackTraceElement) {
        StringBuilder builder = new StringBuilder(64);

        builder.append("[Class:").append(stackTraceElement.getClassName());
        builder.append("] [Method:").append(stackTraceElement.getMethodName()).append("]");
        builder.append(stackTraceElement.isNativeMethod() ? "(Native Method)" :
                (stackTraceElement.getFileName() != null && stackTraceElement.getLineNumber() >= 0 ?
